...
player_vs_PC_easy_button = Button(text="player_vs_PC_easy", command=remove_buttons_player_vs_PC_easy)
player_vs_PC_easy_button.place(x=0,y=30)

player_vs_PC_hard_button = Button(text="player_vs_PC_hard", command=remove_buttons_player_vs_PC_hard)
player_vs_PC_hard_button.place(x=0,y=60)
...
#LINK - main_fun_games_PC_hard =======================   

def main_fun_games_PC_hard(event):
    button_id = event.widget
...
def render_button_games_PC_hard():
    for x_index in range (1,4):
        for y_index in range (1,4):
            dist_button_games[f'button_X{x_index}_Y{y_index}'] = Button(text=" ", bg="#fcb678" , font=("Arial", 25))
            dist_button_games[f'button_X{x_index}_Y{y_index}'].place(x=140 + (60 * x_index),y=100 + (60 * y_index) , width=50, height=50)
            dist_button_games[f'button_X{x_index}_Y{y_index}'].bind("<Button-1>" , main_fun_games_PC_hard)
